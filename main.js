/**
  ...
  *
  * @var t            »грок
  * @var change       —мена игрока
  * @var empty1       «начение €чейки 1 игрового пол€
  * @var empty2       «начение €чейки 2 игрового пол€
  * @var empty3       «начение €чейки 3 игрового пол€
  * @var empty4       «начение €чейки 4 игрового пол€
  * @var empty5       «начение €чейки 5 игрового пол€
  * @var empty6       «начение €чейки 6 игрового пол€
  * @var empty7       «начение €чейки 7 игрового пол€
  * @var empty8       «начение €чейки 8 игрового пол€
  * @var empty9       «начение €чейки 9 игрового пол€
  * @var whogoesnow   „ь€ сейчас очередь	
*/
function variables() {  
    t = 1;    
    change = 1;   
...
/**
  * ќпределение услови€ победы игрока
*/
function win() { 
...
/**
  * —мена игрока
  * ≈сли ходил первый игрок, то устанавливаетс€ новое значение свойства
  * иначе возращаетс€ исходное значение
  *
  * @return t   ¬озвращает номер игрока	
*/
...
/**
  * »змение €чеек игрового пол€ 
  *
  * @return xo  –езультат €чейки	
*/
...
/**
  * ѕерерисовка игровой €чейки
  *
  * @param form ‘орма с игровым полем
  *
  * @return  »зменЄнную €чейку в процессе игры	
*/
